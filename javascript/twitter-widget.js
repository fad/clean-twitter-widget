        ...
        init: function(opts) {
          ...
          if (opts.version >= 2 && !TWTR.Widget.hasLoadedStyleSheet) {
            if (isHttps) {
              ...
              twttr.loadStyleSheet('./stylesheets/twitter-widget.css', this.widgetEl);
            }
          }
...
/*
        ...
        */
        ...
        _getWidgetHtml: function() {
          ...
          var html = '<div class="twtr-doc' + isFull() + '">\
...
function tweetToHtml(tweet)
{
  ...
  if (tweet.indexOf("http:") != -1){
    var link = tweet.match(/http.*/);
    html = "<a href='"+link+"' target='_blank'> > "+tweet.replace(link,"")+"</a>";
  }
  return html;;
}